...
//utility items
    public static final Item DATA_TABLET = registerItem("data_tablet", new DataTabletItem(new FabricItemSettings()));
    public static final Item WRENCH = registerItem("wrench", new wrench(new FabricItemSettings().maxDamage(256)));
